...
class PatchContractTest {
	...
	void testSetAndGetAllFields() {
		...
		final var leasehold = PatchLeasehold.builder().build();
		...
		final var notice = PatchNotice.builder().build();
		final var extension = PatchExtension.builder().build();
		final var fees = PatchFees.builder().build();
		final var invoicing = PatchInvoicing.builder().build();
		final var startDate = LocalDate.of(2020, 1, 1);
		final var endDate = LocalDate.of(2022, 12, 31);
		final var currentPeriod = PatchPeriod.builder().build();
		final var area = 150;
