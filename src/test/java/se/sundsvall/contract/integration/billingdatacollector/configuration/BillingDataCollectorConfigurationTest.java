...
class BillingDataCollectorConfigurationTest {
	...
	@Mock
	private BillingDataCollectorProperties propertiesMock;

	@Test
	void testFeignBuilderCustomizer() {
		final var configuration = new BillingDataCollectorConfiguration();
