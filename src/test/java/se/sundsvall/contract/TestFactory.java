...
public final class TestFactory {
	...
	public static ContractEntity.ContractEntityBuilder createContractEntityBuilder() {
		return ContractEntity.builder()
			...
			.withCurrentPeriodStartDate(LocalDate.now().minusMonths(2))
			.withCurrentPeriodEndDate(LocalDate.now().plusMonths(3))
		...
		return Contract.builder()
			...
			.withStakeholders(List.of(
				Stakeholder.builder()
					.withFirstName("someFirstName")
					.withLastName("someLastName")
					.withOrganizationNumber("212000-2411")
					.withOrganizationName("someOrganizationName")
					.withPartyId("40f14de9-815d-44a5-a34d-b1d38b628e07")
