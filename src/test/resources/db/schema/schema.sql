    ...
    create table contract (
        ...
        lease_type varchar(64) check ((lease_type in ('USUFRUCT_FARMING','LAND_LEASE_LICENSE','SITE_LEASE_COMMERCIAL','LAND_LEASE_RESIDENTIAL','USUFRUCT_HUNTING','OTHER_FEE','LAND_LEASE_MISC','LAND_LEASE_MUNICIPALITY','USUFRUCT_MISC'))),
        ...
        type varchar(64) check ((type in ('OBJECT_LEASE','LAND_LEASE_PUBLIC','SHORT_TERM_LEASE_AGREEMENT','MAINTENANCE_AGREEMENT','LEASE_AGREEMENT','PURCHASE_AGREEMENT','LEASEHOLD'))),
