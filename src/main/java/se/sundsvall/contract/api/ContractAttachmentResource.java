...
class ContractAttachmentResource {
    ...
    ResponseEntity<Contract> getContractAttachmentById(
            ...
            @Parameter(description = "Attachment id") @PathVariable("attachmentId") final String attachmentId) {
    ...
    @PutMapping(path = "/{attachmentId}/metadata", consumes = APPLICATION_JSON_VALUE, produces = {APPLICATION_JSON_VALUE, APPLICATION_PROBLEM_JSON_VALUE})
    ResponseEntity<Contract> updateContractAttachmentMetadata(
            @Parameter(name = "municipalityId", description = "Municipality id") @ValidMunicipalityId @PathVariable("municipalityId") final String municipalityId,
    ...
    ResponseEntity<Void> deleteContractAttachment(
            @Parameter(name = "municipalityId", description = "Municipality id") @ValidMunicipalityId @PathVariable("municipalityId") final String municipalityId,
            @Parameter(description = "Contract id") @PathVariable("contractId") final String contractId,
            @Parameter(description = "Attachment id") @PathVariable("attachmentId") final Long attachmentId) {
