INSERT INTO contract (id, contract_id, status, municipality_id, description,
                      ...
                      lease_extension, lease_extension_unit, start_date, external_reference_id, invoice_interval, invoiced_in,
...
VALUES (2, '2024-23456', 'DRAFT', '1984',
        'someDescription',
        false, 12, true, '2023-10-10', 'LAND_LEASE_RESIDENTIAL', 1, 'YEARS', '2023-10-02', 'MK-TEST0002',
       ...
       (4, '2024-34567', 'ACTIVE', '1984',
        'Land lease residential',
        false, 500, false, '2025-12-31', 'LAND_LEASE_RESIDENTIAL', 2, 'YEARS', '2024-01-01', 'MK-TEST0004',
...
VALUES (2, 'SUNDSVALL NORRMALM 2:1', "District 2"),
